...
------
RegisterNetEvent('APPART:Sound:PlayOnOne')
AddEventHandler('APPART:Sound:PlayOnOne', function(soundFile, soundVolume, loop)
    SendNUIMessage({
...
RegisterNetEvent('APPART:Sound:StopOnOne')
AddEventHandler('APPART:Sound:StopOnOne', function()
    SendNUIMessage({
...
------
RegisterNetEvent('APPART:Sound:PlayOnAll')
AddEventHandler('APPART:Sound:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
RegisterNetEvent('APPART:Sound:PlayWithinDistance')
AddEventHandler('APPART:Sound:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
